var WIDTH = window.innerWidth, HEIGHT = window.innerHeight;
        ...
        function init(){
            ...
            text.innerHTML = "Temukan Virus Covid 19";
            text.innerHTML = "Level: " + (score);
        ...
        function restart(){
            ...
            // untuk menambah setiap mendapatkan virus maka level akan bertambah 1
            score += 1;
        }
        ...
        function render(){
            ...
            if(tetha > delta){
                ...
                for(var i = snake.length - 3; i > -1; i--){
